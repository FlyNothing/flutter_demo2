...
testSkipWhile() {
  Stream<int> s = Stream.fromFutures([Future.value(110), Future.value(130), Future.value(160), Future.value(210), Future.value(230), Future.value(260)]).skipWhile((data) => data < 200);
  s.listen((data) => print("onData: $data"));
