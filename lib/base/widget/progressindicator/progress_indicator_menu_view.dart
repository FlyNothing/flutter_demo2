...
List<BaseMenuVO> progressIndicatorMenuList = [
  BaseMenuVO("圆形指示器1", const CircularProgressIndicatorView(), binding: BindingsBuilder.put(() => ProgressIndicatorController())),
  BaseMenuVO("圆形指示器2", const CircularProgressIndicator2View(), binding: BindingsBuilder.put(() => CircularProgressIndicator2Controller())),
  BaseMenuVO("线性指示器", const LinearProgressIndicatorView(), binding: BindingsBuilder.put(() => ProgressIndicatorController())),
];
