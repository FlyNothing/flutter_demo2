    ...
    return Column(
      children: [
        Container(
          ...
          child: Column(
            children: [Padding(padding: EdgeInsets.symmetric(vertical: 10.h)), StandardTextButton("相册", () => _pickImage()), Padding(padding: EdgeInsets.symmetric(vertical: 10.h)), _getImageView()],
          ),
        )
      ],
    );
