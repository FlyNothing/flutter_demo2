...
import 'package:flutter_demo2/plugin/photoview/photo_view.dart';
import 'package:flutter_demo2/plugin/photoview/photo_view_scale_state_ctrl_view.dart';
import 'package:get/get.dart';

List<BaseMenuVO> photoViewMenuList = [
  BaseMenuVO("PhotoView", const PhotoGetxView(), binding: BindingsBuilder.put(() => ImagePickerImageController())),
  BaseMenuVO("PhotoView.customChild", const PhotoViewCustomChildView(), binding: BindingsBuilder.put(() => PhotoViewCustomChildController())),
  ...
  BaseMenuVO("PhotoViewScaleStateController", const PhotoViewScaleStateControllerView(), binding: BindingsBuilder.put(() => PhotoViewScaleStateCtrlController())),
];
