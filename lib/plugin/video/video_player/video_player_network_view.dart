...
class VideoPlayerNetworkPage extends StatefulWidget {
  const VideoPlayerNetworkPage(this._title, {Key? key}) : super(key: key);
  final String _title;
...
class _VideoPlayPageState extends State<VideoPlayerNetworkPage> {
